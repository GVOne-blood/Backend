...
This application was generated using JHipster 8.8.0-R8, you can find documentation and help
at [https://www.jhipster.tech/documentation-archive/v8.8.0-R8](https://www.jhipster.tech/documentation-archive/v8.8.0-R8).
...
- `.yo-rc.json` - Yeoman configuration file
  JHipster configuration is stored in this file at `gen-jhipster` key. You may find `gen-jhipster-*` for specific
...
[JHipster 8.8.0-R8 archive]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8

[Doing microservices with JHipster]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/microservices-architecture/

[Using JHipster in development]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/development/

[Using Docker and Docker-Compose]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/docker-compose

[Using JHipster in production]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/production/

[Running tests page]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/running-tests/

[Code quality page]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/code-quality/

[Setting up Continuous Integration]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/setting-up-ci/
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v8.8.0-R8/doing-api-first-development/

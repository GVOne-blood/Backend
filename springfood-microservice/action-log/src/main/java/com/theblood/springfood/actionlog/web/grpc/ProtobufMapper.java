//package com.viettel.dvs.actionlog.web.grpc;
//
...
//	private static final Pageable DEFAULT_PAGE_REQUEST = org.springframework.data.domain.PageRequest.of(0, 20);
//
...
//		return date == null
//			? null
//			: Date.newBuilder().setYear(date.getYear()).setMonth(date.getMonthValue()).setDay(date.getDayOfMonth()).build();
//	}
//
//	public static ZonedDateTime timestampToZonedDateTime(Timestamp timestamp) {
//		return timestamp == null
//			? null
//			: ZonedDateTime.ofInstant(Instant.ofEpochSecond(timestamp.getSeconds(), timestamp.getNanos()), ZoneId.of("UTC"));
//	}
//
...
//		return decimal == null ? null : BigDecimal.valueOf(Double.parseDouble(decimal.getValue()));
//	}
//
//	public static Decimal bigDecimalToDecimalProto(BigDecimal decimal) {
//		return decimal == null ? null : Decimal.newBuilder().setValue(decimal.toPlainString()).build();
//	}
//
...
//
//		List<Sort.Order> orders = pageRequestProto
//			.getOrdersList()
//			.stream()

...
/**
 * Criteria class for the {@link LogAction} entity. This class is used
 * in {@link LogActionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /log-actions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class LogActionCriteria implements Serializable, Criteria {
    ...
    public LogActionCriteria() {
    }

    public LogActionCriteria(LogActionCriteria other) {
    ...
    @Override
    public LogActionCriteria copy() {
        return new LogActionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LogActionCriteria that = (LogActionCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, accountId, userName, organizationId, actionType, ipAddress, objectId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "LogActionCriteria{" +

...
import com.theblood.authentication.common.util.PasswordEncoderUtil;
import com.theblood.authentication.dto.request.SearchCriteria;
...
import com.theblood.authentication.mapper.UserMapper;
import com.theblood.authentication.model.Role;
import com.theblood.authentication.model.User;
import com.theblood.authentication.model.UserHasRole;
import com.theblood.authentication.repository.RoleRepository;
import com.theblood.authentication.repository.SearchSpecification;
...
//        cart.setUser(user);
    ...
    public UserDetail updateUser(UUID userId, UserRequest userRequest) {

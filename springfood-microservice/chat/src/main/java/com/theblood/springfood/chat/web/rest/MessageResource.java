...
public class MessageResource {
    ...
    public ResponseEntity<MessageDTO> createMessage(@Valid @RequestBody MessageDTO messageDTO) throws URISyntaxException {
        ...
        if (messageRepository.existsById(messageDTO.getMessageId())) {
            throw new BadRequestAlertException("message already exists", ENTITY_NAME, "idexists");
        }
        messageDTO = messageService.save(messageDTO);
        return ResponseEntity.created(new URI("/api/messages/" + messageDTO.getMessageId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, messageDTO.getMessageId()))
            .body(messageDTO);
    }
    ...
    public ResponseEntity<MessageDTO> updateMessage(
        ...
        LOG.debug("REST request to update Message : {}, {}", messageId, messageDTO);
        if (messageDTO.getMessageId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(messageId, messageDTO.getMessageId())) {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, messageDTO.getMessageId()))
            .body(messageDTO);
    }
    ...
    public ResponseEntity<MessageDTO> partialUpdateMessage(
        ...
        LOG.debug("REST request to partial update Message partially : {}, {}", messageId, messageDTO);
        if (messageDTO.getMessageId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(messageId, messageDTO.getMessageId())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, messageDTO.getMessageId())
        );
    }
